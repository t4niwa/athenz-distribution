...
mirror-athenz-amd64-images:
	IMAGE=athenz-db; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=athenz-zms-server; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=athenz-zts-server; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=athenz-ui; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=athenz-cli; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=k8s-athenz-sia; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=athenz-plugins; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=crypki-softhsm; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=certsigner-envoy; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
	IMAGE=athenz_user_cert; docker pull --platform linux/amd64 ghcr.io/t4niwa/$$IMAGE:latest && docker tag ghcr.io/t4niwa/$$IMAGE:latest docker.io/tatyano/$$IMAGE:latest && docker push docker.io/tatyano/$$IMAGE:latest
